...
<html lang="en">
  ...
  <body class="nav-on-header smart-nav">
    ...
    <header class="page-header bg-img size-lg" style="background-image:url(.//assets/img/bg-facts.jpg)">
        <div class="container">
            <div class="header-detail"> <h2>Yanıtlar</h2>
      ...
      /*   $id=$_SESSION['id'];
         ...
         while($idbul=$sor->fetch(PDO::FETCH_ASSOC)) { 
            ...
            echo $anket_id;*/
            $anket_id=$_GET["id"];
            $sorusayi  = $baglanti->query("SELECT * FROM yanitlar WHERE anket_id ='$anket_id'");
            ...
            while($sorgu=$query->fetch(PDO::FETCH_ASSOC)) {  ?>
                ...
                <div class="button-group">
                    <div class="action-buttons">
                        <a class="btn btn-success" href="#">Yanıtları İndir</a>
        ...
        <div class="item-block">
            <div class="item-form ">
                ...
                <div class="col-xs-12 col-sm-12">
                        ...
                        <?php   $seceneksayi  = $baglanti->query("SELECT * FROM yanitlar  WHERE soru_id ='$soruno'");
                            ...
                            <div class="form-group">
                                <div class="input-group" style="border-bottom:1px solid; border-color: #cacaca">
                                    ...
                                    <input type="text" class="form-control col-sm-10"
                                        style="background-color:transparent;  border:none; width:95%; font-size:17px;"
                                        value="<?php echo $secenek["yanit"]; ?>"  onkeypress="return false;">
                                        <i style="color:#55595c; font-size:40px; margin-right:15px; position:absolute; top:5px; right:80px;" class=" btn-float "><?php echo $secenek["y_sayi"]; ?></i> </input>
