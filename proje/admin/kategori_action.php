    ...
    if($_POST["action"] == "Load") 
    {
     ...
     $output .= '
      <table class="table table-bordered">
       <tr>
        <th >Kategori Adı</th>
        <th >Kategoriler Arasında Gösterilsin mi?</th>
        <th >Popüler Kategorilerde Gösterilsin mi?</th>
        <th >Güncelle</th>
        <th >Sil</th>
       </tr>
     '; 
  ...
  <td align="center">..................................</td>
   ...
   if($_POST["action"] == "Ekle")
   {
    $statement = $connection->prepare("
     INSERT INTO kategoriler (cname, confirm, i_confirm) 
     VALUES (:cname, :confirm, :i_confirm)
    ");
   ...
   if($_POST["action"] == "Güncelle")
   {
    $statement = $connection->prepare(
     "UPDATE kategoriler 
     SET cname = :cname, confirm = :confirm , i_confirm = :i_confirm
     WHERE id = :id
     "
    );
    $result = $statement->execute(
